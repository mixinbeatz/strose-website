...
- There is a separate admin "portal" (not in this repo) that actually edits this Firestore data — the `Admin ▾` link in `index.html`'s nav points to it but is currently a no-op placeholder in this codebase.
